...
class Line:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.exp = args
...
class Wave:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.amp, self.frq, self.pha = args
...
class Arc:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.fac = args
...
class Helix:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.length, self.fac, self.steps, self.pha = args
...
class Spiral:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.revs = args
...
class Torus:
    ...
    def anim_update(self, *args):
        self.ioff, self.dim, self.steps, self.pha = args
